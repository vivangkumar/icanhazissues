...
try {
  ...
  CONFIG = {
    ...
    "wipLimits": {
      "ready": process.env.READY_WIP_LIMIT || 3,
      "development": process.env.DEVELOPMENT_WIP_LIMIT || 3,
      "review": process.env.REVIEW_WIP_LIMIT || 3,
      "release": process.env.RELEASE_WIP_LIMIT || 3,
      "done": process.env.DONE_WIP_LIMIT || 3
    }
  }
}
